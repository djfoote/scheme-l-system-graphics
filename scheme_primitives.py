...
@primitive("color_rgb", "color3")
def tscheme_color_rgb(r, g, b):
    """Set the color to the color represented by rgb values r, g, b
    """
    _tscheme_prep()
    turtle.color(r, g, b)
    return okay
...
@primitive("getr")
def tscheme_getcolor():
    _tscheme_prep()
    return turtle.pencolor()[0]

@primitive("getg")
def tscheme_getcolor():
    _tscheme_prep()
    return turtle.pencolor()[1]

@primitive("getb")
def tscheme_getcolor():
    _tscheme_prep()
    return turtle.pencolor()[2]

@primitive("fillcolor")
def tscheme_fillcolor(r, g, b):
    _tscheme_prep()
...
@primitive("pensize")
def tscheme_pensize(s):
    _tscheme_prep()
    turtle.pensize(s)
    return okay

@primitive("getposition", "getpos")
def tscheme_getposition():
    _tscheme_prep()
    return Pair(turtle.xcor(), turtle.ycor())


@primitive("getheading", "geth")
def tscheme_getheading():
    _tscheme_prep()
